...
const getPreferredLanguageHint = (): string => 'English';
...
`;
    ...
    if (action === 'analyzeSmartLink') {
      ...
      const languageHint = getPreferredLanguageHint();
...
D. Primary Domain: [Video Editing/AI/etc]

[Follow all 10 steps from original spec exactly]
...
No extra text.`;
      ...
      json(res, 200, { ok: true, data: parsedData });
      return;
    }
